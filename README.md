...
============================================================
1. -WindowsRuntime.exe (Verknüpfung) ausführen
...
2. -Bei Backupbedarf PiServerBackup.exe (Verknüpfung) ausführen
...
Öffnen Sie die uninstall.exe Datei im internal Ordner
